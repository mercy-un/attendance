            ...
            <div class="container-fluid pt-25">
				...
				<div class="row">
					...
					<div style="magin-bottom:5px; margin-top:5px;"></div>
									...
									<br>
						<p style="text-align:center;"><span style="color:black;">Download Excel Template</span> <a class="btn btn-info btn-sm" href="student_template.xlsx"><i class="fa fa-file-excel-o"></i> Download</a></p>
						<hr style="background-color:lavender; height:;">
												
												
									<div class="form-group"> 
								<label class="control-label mb-5" for="email_de">Upload File</label>
						<input class="form-control" type="file" name="attachment" required>
												...
												<div class="msg"></div>
													<div class="form-group">
									<button class="btn btn-primary btn-sm mb-5 pull-right" type="submit">Upload Student Data</button>
